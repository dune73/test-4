...
```bash
$> cd /usr/src/apache/httpd-2.4.43
$> ./configure --prefix=/opt/apache-2.4.43 --enable-mods-shared=all \
   ...
   --with-suexec-docroot=/opt/apache-2.4.43/bin && make && sudo make install
```
