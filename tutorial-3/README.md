...
```bash
$> cd /usr/src/apache/httpd-2.4.48
$> ./configure --prefix=/opt/apache-2.4.48 --enable-mods-shared=all \
   ...
   --with-suexec-docroot=/opt/apache-2.4.48/bin && make && sudo make install
```
