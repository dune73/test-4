...
```bash
$> cd /usr/src/apache/httpd-2.4.46
$> ./configure --prefix=/opt/apache-2.4.46 --enable-mods-shared=all \
   ...
   --with-suexec-docroot=/opt/apache-2.4.46/bin && make && sudo make install
```
