...
```bash
$> cd /usr/src/apache/httpd-2.4.39
$> ./configure --prefix=/opt/apache-2.4.39 --enable-mods-shared=all \
   ...
   --with-suexec-docroot=/opt/apache-2.4.39/bin && make && sudo make install
```
