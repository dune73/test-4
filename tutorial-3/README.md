...
```bash
$> cd /usr/src/apache/httpd-2.4.51
$> ./configure --prefix=/opt/apache-2.4.51 --enable-mods-shared=all \
   ...
   --with-suexec-docroot=/opt/apache-2.4.51/bin && make && sudo make install
```
